...
var io=require('socket.io'),
    Client=require('socket.io/lib/socket.js');
...
io.listen.prototype.runRegistersCallbackRPC=function(method, params, client, callbacks, result){
  var ret=null;
  var $$=this;
  if(callbacks.length>0)
...
io.listen.prototype._onClientReturnRPC= function(data, client){
...
io.listen.prototype._onClientCallRPC= function(data, client){
 ...
 */
io.listen.prototype._onClientMessage = function(data, client){
 ...
 */
io.listen.prototype.broadcastCallRPC=function(method, params, callback, except){
...
io.listen.prototype.broadcastNotifyRPC=function(method, params, except){
  for (var i = 0, k = Object.keys(this.clients), l = k.length; i < l; i++){
    if (!except || ((typeof except == 'number' || typeof except == 'string') && k[i] != except)
                || (Array.isArray(except) && except.indexOf(k[i]) == -1)){
